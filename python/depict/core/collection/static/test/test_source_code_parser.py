...
class TestSourceCodeParser():
    ...
    def setUp(self):
        self.ast_ng_manager_patcher = patch('depict.core.collection.static.source_code_parser.AstroidManager')
    ...
    @patch('depict.core.collection.static.source_code_parser.sys')
    ...
    @patch('depict.core.collection.static.source_code_parser.RelationsVisitor')
    @patch('depict.core.collection.static.source_code_parser.DefsVisitor')
